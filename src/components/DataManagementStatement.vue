<template>
  <div class="container">
    ...
    <p>
      ...
      <br />Ez a dokumentum a SEQ Legal (seqlegal.com) sablonján alapszik, amelyet a Website Planet módosított (
      <a href="https://www.websiteplanet.com">www.websiteplanet.com</a>)
    </p>
    <p>
      <strong>C. A személyes adatok gyűjtése</strong>
    </p>
    ...
    <p>
      <strong>D. Az Ön személyes adatainak felhasználása</strong>
    </p>
    ...
    <p>
      <strong>E. A személyes adatok közzététele</strong>
    </p>
    ...
    <p>
      <strong>F. Nemzetközi adattovábbítás</strong>
    </p>
    <ol>
    ...
    <p>
      <strong>G. A személyes adatok megőrzése</strong>
    </p>
    <ol>
    ...
    <p>
      <strong>H. Az Ön személyes adatainak biztonsága</strong>
    </p>
    <ol>
    ...
    <p>
      <strong>K. Harmadik felek weboldalai</strong>
    </p>
    ...
    <p>
      <strong>L. Az adatok frissítése</strong>
    </p>
    ...
    <ol start="3">
      <li>
        ...
        <ol type="a">
          <li>
            az Internet Explorer böngészőben (10. verziószám) manuálisan kell törölnie a süti-fájlokat (ehhez a
            <a href="http://support.microsoft.com/kb/278835">http://support.microsoft.com/kb/278835</a> címen talál leírást);
          </li>
